...
function underscores_scripts() {
	wp_enqueue_style( 'underscores-style', get_stylesheet_uri(), '', '20171223.01' );
	...
	wp_enqueue_script( 'main', get_template_directory_uri() . '/js/main.js', array('joint-libs'), '20171223.01', true );
