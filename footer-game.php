...
?>
<!-- Custom JS -->
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/main.js?ver=20171217.06"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/<?php echo $js_file; ?>.js?ver=20171217.06"></script>
</body>
</html>
