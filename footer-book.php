...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/main.js?ver=20171217.05"></script>
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/books-fullscreen.js?ver=20171217.05"></script>
</body>
</html>
