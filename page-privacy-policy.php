 ...
 */
 ...
 <div id="primary" class="content-area">
    ...
    <!--
      ...
      * @headerText
    -->
    <?php echo zb_get_page_header('page-PrivacyPolicy', 'Privacy Policy'); ?>
    ...
    <?php echo zb_get_breadcrumb(false, 'Privacy Policy'); ?>
        ...
        <div class="col-md-12">
          ...
          <h3>Please Note:</h3>
          <p>We are committed to conducting our business in accordance with these principles in order to ensure that the confidentiality of personal information is protected and maintained. Zimmy Books may change its Privacy Policy from time to time, and at Zimmy Books's sole discretion.</p>
