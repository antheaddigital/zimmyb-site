...
<section class="featured">
  ...
  <div class="featured-wrapper">
    <a class="featured-img" href="<?php echo esc_url( site_url() ); ?>/books/bayme-pants-the-sun-its-broken"><img class="img-responsive" src="<?php echo get_template_directory_uri(); ?>/imgs/site/the-sun-its-broken-featured.jpg" /></a>
    <div class="featured-description">
